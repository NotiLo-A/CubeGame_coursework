...
var
  ...
  FTargetWidth: Integer; // Целевая ширина панели
  FStep: Integer = 20;        // Шаг изменения ширины
...
begin
  ...
  // Если достигли целевой ширины, выключаем таймер
  if Panel2.left = FTargetWidth then
    Timer1.Enabled := False;


  if label1.Caption <> 'Undefaind' then
  button1.Caption := 'выйти из аккаунта'
  else
  button1.Caption := 'войти в аккаунт';
